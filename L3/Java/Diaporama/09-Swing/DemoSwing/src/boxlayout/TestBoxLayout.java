...
public class TestBoxLayout extends JFrame {
    ...
    private void definirLesElements() {
        ...
        est.setPreferredSize(new Dimension(100, 100));
        ouest.setPreferredSize(new Dimension(75, 25));
        
       nord.setMinimumSize(new Dimension(0, 0));
        sud.setMinimumSize(new Dimension(0, 0));
        centre.setMinimumSize(new Dimension(0, 0));
        est.setMinimumSize(new Dimension(0, 0));
        ouest.setMinimumSize(new Dimension(0, 0));

...
public class TestCardLayout extends JFrame {
    ...
    public TestCardLayout() {
        ...
        overlaylayout = new OverlayLayout(this.getContentPane());
        ...
        getContentPane().setLayout(overlaylayout);
    ...
    private void placerLesElements() {
        ...
        getContentPane().add(ouest);
        getContentPane().add(centre);
        
        nord.setPreferredSize(new Dimension(50, 10));
        sud.setPreferredSize(new Dimension(45, 50));
        centre.setPreferredSize(new Dimension(75, 25));
        est.setPreferredSize(new Dimension(100, 200));
        ouest.setPreferredSize(new Dimension(250, 250));
        
        nord.setMinimumSize(nord.getPreferredSize());
        sud.setMinimumSize(sud.getPreferredSize());
        centre.setMinimumSize(centre.getPreferredSize());
        est.setMinimumSize(est.getPreferredSize());
        ouest.setMinimumSize(ouest.getPreferredSize());
        
        nord.setMaximumSize(nord.getPreferredSize());
        sud.setMaximumSize(sud.getPreferredSize());
        centre.setMaximumSize(centre.getPreferredSize());
        est.setMaximumSize(est.getPreferredSize());
        ouest.setMaximumSize(ouest.getPreferredSize());
    }

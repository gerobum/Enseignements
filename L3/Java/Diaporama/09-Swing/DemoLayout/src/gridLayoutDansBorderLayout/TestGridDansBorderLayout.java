 ...
 * @author yvan
 */
public class TestGridDansBorderLayout extends JFrame {

    private JLabel nord, sud, est, ouest;
    private JPanelGrid centre;
    ...
    public TestGridDansBorderLayout() {

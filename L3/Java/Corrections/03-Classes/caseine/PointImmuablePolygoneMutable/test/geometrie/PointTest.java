 ...
 /*
    ...
    public void testAfficher() {
        ...
        try {
            ...
            IntrospectionUtilities.setAttribut(Point.class, p, "x", 0);
            IntrospectionUtilities.setAttribut(Point.class, p, "y", 0);
            IntrospectionUtilities.setAttribut(Point.class, p, "rho", 0);
            IntrospectionUtilities.setAttribut(Point.class, p, "theta", 0);
            String rep = IntrospectionUtilities.getFromMethodTASystemOut(Point.class, p, "afficher");
            assertEquals("Afficher en cartésien", rep, "(0.0, 0.0)");
            rep = IntrospectionUtilities.getFromMethodTASystemOut(Point.class, p, "afficher", boolean.class, true);
            assertEquals("Afficher en polaire", rep, "[0.0:0.0]");
        } catch (InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchMethodException | NoSuchFieldException | IOException ex) {
            fail("Afficher");
        }
    }
}

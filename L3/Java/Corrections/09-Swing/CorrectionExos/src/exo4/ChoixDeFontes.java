...
public class ChoixDeFontes extends JFrame {
    ...
    /**
     * Crée une JFrame qui permet de voir les différentes polices de caractères qui existent
     * dans l'environnement.
     * Une boite à liste permet de choisir une police de caractères
     * Un champ de saisie autorise le choix de la taille
     * Deux cases à cocher permettent de sélectionner de changer la graisse de la police et
     * de la mettre en italique ou non.
     **/

...
/**
 * Permet de visualiser les couleurs en faisant varier leur composantes
 * rouge, verte et bleue à l'aide de 3 glisseurs (sliders)
 * @author Yvan Maillot
 */
public class ChoixDeCouleurs extends JFrame {
    ...
    /** Crée une JFrame dont le titre est "Choisir une couleur"
     *  dans laquelle se trouvent trois glisseurs (JSlider) qui
     *  permettent de faire varier les composantes rouge, verte et bleue
     *  de la couleur du panneau qui se trouve au centre.
     **/

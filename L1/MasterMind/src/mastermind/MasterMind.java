...
public class MasterMind {
    ...
    public static void main(String[] args) {
        ...
        while (n < propositions.length && !"4BP 0MP".equals(resultat)) {
            ...
            resultat = comparer(proposition, aDeviner);
        ...
        if ("4BP 0MP".equals(resultat)) {
            System.out.println("Gagné");
            System.out.println("C'était bien " + aDeviner);
        } else {
    ...
    private static void affichage(String[][] propositions) {
        for (int l = 0; l < propositions.length; ++l) {
            System.out.println(propositions[l][0] + " - "
                    + propositions[l][1]);
        }
    }

    private static String saisirProposition(int nc, int nb) {
        System.out.print("Entrez " + nb + " caractères entre A et " + unCar(nc - 1) + " : ");
        Scanner in = new Scanner(System.in);
    ...
    private static String comparer(String proposition, String aDeviner) {
        int nbp = 0;
        int nmp = 0;

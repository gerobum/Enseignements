 ...
 * La dimension du terrain en X et en Y Une fourmi y sera représentée par un
 * rectangle plein dont la dimension est modifiable : (tailleFourmiX x
 * tailleFourmiY).
 *
 * @author maillot
 */
public class Terrain extends JPanel {
     ...
     * nombre de fourmis en X et Y se fait en fonction de la dimension de la

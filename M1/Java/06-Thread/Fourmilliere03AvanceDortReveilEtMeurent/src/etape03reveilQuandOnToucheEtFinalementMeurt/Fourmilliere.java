package etape03reveilQuandOnToucheEtFinalementMeurt;
 ...
 * </ol>
 * Appuyer sur le bouton "fourmi" lance le nombre de fourmis donné dans le champ
 * de saisie "combien" ou 1 fourmi si rien n'y est indiqué ou si la champ n'est
 * pas convertible en entier. Le label "quantite" indique en permanance le
 * nombre de fourmis qui s'animent dans le panneau.
 *
 * @author maillot
 */

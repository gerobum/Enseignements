...
/**
 * Le terrain de jeu des fourmis. Il peut contenir au départ 80x50 fourmis.
 * La dimension du terrain en X et en Y <br>
...
public class Terrain extends JPanel {
    ...
    public void setTailleFourmiX(int tailleFourmiX) {
        this.tailleFourmiX = tailleFourmiX < 1 ? 1 : tailleFourmiX;
        changementDeDimension();
    }
    ...
    public void setTailleFourmiY(int tailleFourmiY) {
        this.tailleFourmiY = tailleFourmiY < 1 ? 1 : tailleFourmiY;
        changementDeDimension();
    }

...
public class Fourmi implements Runnable {
    ...
    public void run() {
        ...
        //  #### Finalement ce qui suit devient inutile
        /*while (true) {
            try {
                synchronized (this) {
                   this.wait();
    ...
    // #### Ce sera plus simple avec cette méthode
    ...
    private void avance() {
        ...
        if (voisin == null) {
            ...
            x = xa;
            y = ya;
            // #### On relance le thead du voisin s'il dort
            // #### Enfin, il était mort alors on le ressuscite.
            voisin.ressuscite();
        }

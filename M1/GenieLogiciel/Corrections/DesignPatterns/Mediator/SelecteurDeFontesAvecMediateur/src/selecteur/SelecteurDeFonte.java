...
public class SelecteurDeFonte extends JFrame {
    ...
    public SelecteurDeFonte() {
        ...
        mediateur = new Mediateur(fonteExemple, comboBoxFamille, normal, bold, demibold, roman, italique, oblique, spinnerSize, condense);

        pack();
        
        comboBoxFamille.addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent e) {
                mediateur.valueChanged(comboBoxFamille);
            }
        });

...
// #### V2.0 /customer met null dans categoryname.
    public String findAll(@PathVariable(required = false, name = "categoryname") String categoryname, Model model, HttpSession session) {
        ...
        LOGGER.info(" **************************************************************************** ");
        LOGGER.info(" ************************** Dernière visite : " + session.getAttribute("der"));
        LOGGER.info(" ************************** N°Session : " + session.getId());
        LOGGER.info(" **************************************************************************** ");
        session.setAttribute("der", "/customer");
        ...
        list.add("/customer");
        LOGGER.info(" **************************************************************************** ");
        LOGGER.info(" ========================== Toutes les visites : ");
        for (String v : list) {
            LOGGER.info(" ----------------------------->  : " + v);
        }
        LOGGER.info(" **************************************************************************** ");

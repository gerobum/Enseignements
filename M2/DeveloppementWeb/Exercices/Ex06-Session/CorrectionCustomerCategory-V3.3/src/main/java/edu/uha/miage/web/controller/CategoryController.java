...
import edu.uha.miage.models.CategoryModel;
...
public class CategoryController {
    ...
    public String findAll(Model model, HttpSession session) {
        // #### V3.0 Store path in the list off the session
    ...
    public String create(Model model, HttpSession session) {
        // #### V3.0 Store path in the list on the session
    ...
    @PostMapping("/create")
    // #### V3.3 lang parameter to internationalize error message 
    public String created(@Valid Category category, BindingResult br, String lang) {
        ...
        // #### V3.3 If we use CategoryModel (but there a better way)
        // #### V3.3 if (!CategoryModel.tryToSave(categoryService, category, lang, br, messageSource)) {
        // #### V3.3     return "category/edit";
        // #### V3.3 }
        // #### V3.3 Otherwise, just try to save category and if there is an       
        // #### V3.3  exception, it is handle by @ExceptionHandler
    ...
    public String edited(@Valid Category category, BindingResult br, String lang) {
        ...
        // #### V3.3 Otherwise, just try to save category and if there is an       
        // #### V3.3  exception, it is handle by @ExceptionHandler
        // #### V3.3  (!CategoryModel.tryToSave(categoryService, category, lang, br, messageSource)) {
        // #### V3.3   return "category/edit";
        // #### V3.3  }
        categoryService.save(category);
        return "redirect:/category";
    ...
    // #### V3.0 Just add a HttpSession parameter to get it
    // #### V3.3 lang parameter to internationalize error message 
    public String delete(@PathVariable("id") Long id, HttpSession session, String lang) {
        // #### V3.0 Store path in the list on the session
        ...
        // #### V3.3   return "category/edit";
        // #### V3.3  }
        // #### V3.3 if (!CategoryModel.tryToDelete(categoryService, id, lang, messageSource)) {
        // #### V3.3     return "error";
        // #### V3.3 }
    ...
    // #### V3.3 Exception handling by type
    // #### V3.3 https://spring.io/blog/2013/11/01/exception-handling-in-spring-mvc#sample-application
    
    // #### V3.3 Database exceptions handling
    // #### V3.3 This method is invoked if such Exception are thrown
    ...
    // #### V3.3 Other exceptions handling

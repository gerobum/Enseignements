...
public class Controleur extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Salut " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean genre = "h".equals(request.getParameter("sexe"));
        String nom, prenom;
        ...
        Personne yvan = new Personne(
                genre,
                nom,
                prenom,
                age);
        request.setAttribute("personne", yvan);

 ...
 */
package edu.uha.miage.mag.models.session;
...
public class PanierModel implements Serializable {
    ...
    public static Object handle(HttpServletRequest request) {
        ...
        if (request.getSession().getAttribute("modelSession") == null) {
            model = new PanierModel();
            System.out.println("NULL");
        } else {
            model = (PanierModel) request.getSession().getAttribute("modelSession");

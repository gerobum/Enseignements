...
public class CustomerController {
    ...
    public String create(Model model) {
        ...
        model.addAttribute("customer", groupe);
        model.addAttribute("categories", categoryService.findAll());
        return "customer/edit";
    }

    @PostMapping("/create")
    public String created(@Valid Groupe groupe, BindingResult br, Model model) {
    ...
    @PostMapping("/edit")
    public String edited(@Valid Groupe groupe, BindingResult br, Model model) {

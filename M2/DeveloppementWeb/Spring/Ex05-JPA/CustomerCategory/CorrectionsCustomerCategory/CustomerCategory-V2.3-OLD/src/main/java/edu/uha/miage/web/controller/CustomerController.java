...
// #### V1.4 initialement a disparu. Il faut la recréer.
        ...
        // #### V2.3 Arrivée ici, il n'y a pas d'erreur de validation
        // #### V2.3 Mais une erreur peut survenir si la catégorie existe déjà
        // #### V2.3 Dans ce cas on peut injecter un message d'erreur associé à
        // #### V2.3 un champ (duplicate-category) est une clé pour l'i18n.
        /*try {
            customerService.save(customer);
        } catch (Exception ex) {
            br.rejectValue("name", "duplicate-customer");//(" + customer + ")");

/* #### V2.1 This file has been added for the conditional configuration of the 
database according to the dev or prod profile. */
...
@ComponentScan("edu.uha.miage.core")
@EnableJpaRepositories(basePackages = {"edu.uha.miage.core.repository"})
...
public class SpringCoreConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emfb.setPackagesToScan("edu.uha.miage.core");

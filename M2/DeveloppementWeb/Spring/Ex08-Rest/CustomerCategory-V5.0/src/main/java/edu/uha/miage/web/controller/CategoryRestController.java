...
public class CategoryRestController {
    ...
    public Category findACategory(@PathVariable(name = "id", required = false) long id, HttpServletResponse response) {
        try {
    ...
    public String put(@Valid Category category, BindingResult br) {
        if (br.hasErrors()) {
            return br.toString();
        }
    ...
    public String created(@RequestBody Category category, HttpServletResponse response) {
        try {
            categoryService.save(category);
           return "OK";
        } catch (Exception ex) {

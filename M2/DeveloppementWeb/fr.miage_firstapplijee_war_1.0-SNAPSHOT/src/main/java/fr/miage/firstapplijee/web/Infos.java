 ...
 * @author yvan
 */
@WebServlet(name = "Infos", urlPatterns = {"/infos"})
public class Infos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Infos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Infos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
@Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /*try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<html>");
            out.print("<head>");
            out.print("<title>Infos</title></head>");
            out.print("<body>");
